# Cvičenie 11: Súbory, steny a prekážky
...
[Vypracované úlohy z predošlých cvičení nájdete na tomto odkaze.](lab11/Project1_after10.zip)
...
Rovnaké rozmery nastavte aj pre `GameWorld` objekt v metóde `LoadContent()`.
